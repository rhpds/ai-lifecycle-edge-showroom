...
image::4-1_workbench.png[Workbenches tab showing model-training workbench,link=self,window=blank,width=700]
...
image::4-1_jupyterlab.png[JupyterLab dashboard,link=self,window=blank,width=700]
...
+
image::4-2_git-import.png[JupyterLab Git clone option,link=self,window=blank,width=700]
...
image::4-2_imported-folder.png[The ai-lifecycle-edge-automation folder is imported,link=self,window=blank,width=700]
...
image::4-3_run-notebooks.png[Play and Double Play buttons to run the Notebook,link=self,window=blank,width=700]
