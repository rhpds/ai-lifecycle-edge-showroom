...
* Trains 2 AI models based using the new data
* Serve both models to test performace
...
This RHOAI operator is deployed on an **Single Node OpenShift** instance with greater compute capacity at the plant. SNO is optimized for edge locations providing enterprise Kubernetes features in a single-node deployment.
