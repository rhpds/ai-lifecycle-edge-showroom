...
. In the **Red Hat OpenShift AI Dashboard**, navigate to the `ai-edge-project` project
...
. File timestamps show recent updates
...
✓ File timestamps show recent updates (in case the new models outperform the existing ones)
...
. In the **Red Hat OpenShift AI Dashboard**, navigate to the **Pipeline definitions** tab
