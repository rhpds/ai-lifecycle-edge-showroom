...
This hands-on workshop demonstrates an end-to-end AI solution for battery health monitoring in autonomous transportation robots operating in industrial facilities. You'll explore **Red Hat Device Edge (MicroShift)**, **Single Node OpenShift (SNO)**, and **Red Hat OpenShift AI (RHOAI)** working together to enable intelligent automation at the edge.
...
Access credentials will be provided dynamically for your deployment.
...
* Review RHOAI installation
* Review DataScience project
* Review DataConnection to robot storage
...
* Test battery health alerts and dashboard
* Monitor real-time inference execution
* Verify model performance and latency

**xref:09-conclusion.adoc[Conclusion]** - Summary and next steps
